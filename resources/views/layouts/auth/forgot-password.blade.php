...
<div class="flex justify-center items-center px-2 my-5">
    <div class="bg-black/80 p-10 rounded max-w-md w-full z-10">
        ...
        <form action="{{ route('password.email') }}" method="POST" class="flex flex-col gap-4 w-full">
            ...
            <!-- Email -->
            <input type="email" name="email" placeholder="Email address" required class="p-3 w-full rounded bg-[#222] text-white border border-gray-500 placeholder-gray-400 focus:border-red-600 focus:ring-1 focus:ring-red-600 outline-none">
