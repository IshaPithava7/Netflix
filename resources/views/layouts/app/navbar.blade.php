<header id="navbar"
    class="flex items-center justify-between h-16 w-full px-14 fixed top-0  z-50 transition-colors duration-700">
    {{-- Logo Section --}}
    <div class=" flex items-center flex-shrink-0">
        <a href="#">
            <img src="{{ asset('storage/logo/Logonetflix.png') }}" alt="Netflix Logo" class="w-[100px] h-auto">
        </a>
    </div>


    {{-- Navigation Menu --}}
    <nav class="flex items-center flex-1 ml-[15px] pt-[20px] ">
        <ul class="flex items-center space-x-5 text-sm">
            <li
                class="{{ request()->routeIs('home') ? 'font-bold text-white' : 'text-white' }} hover:text-gray-300 cursor-pointer transition-colors duration-200">
                <a href="{{ route('home') }}" class="!no-underline text-white">Home</a>
            </li>
            <li
                class="{{ request()->routeIs('shows') ? 'font-bold text-white' : 'text-white' }} hover:text-gray-300 cursor-pointer transition-colors duration-200">
                <a href="{{ route('shows') }}" class="!no-underline text-white">Shows</a>
            </li>
            <li
                class="{{ request()->routeIs('movies') ? 'font-bold text-white' : 'text-white' }} hover:text-gray-300 cursor-pointer transition-colors duration-200">
                <a href="{{ route('movies') }}" class="!no-underline text-white">Movies</a>
            </li>

            <li
                class="{{ request()->routeIs('games.*') ? 'font-bold text-white' : 'text-white' }} hover:text-gray-300 cursor-pointer transition-colors duration-200">
                <a href="{{ route('games.index') }}" class="!no-underline text-white">Games</a>
            </li>
            <li
                class="{{ request()->routeIs('newpopular') ? 'font-bold text-white' : 'text-white' }} hover:text-gray-300 cursor-pointer transition-colors duration-200">
                <a href="{{ route('newpopular') }}" class="!no-underline text-white">New & Popular</a>
            </li>
            <li
                class="{{ request()->routeIs('mylist.index') ? 'font-bold text-white' : 'text-white' }} hover:text-gray-300 cursor-pointer transition-colors duration-200">
                <a href="{{ route('mylist.index') }}" class="!no-underline text-white">My List</a>
            </li>
            <li
                class="{{ request()->routeIs('browse.languages') ? 'font-bold text-white' : 'text-white' }} hover:text-gray-300 cursor-pointer transition-colors duration-200">
    ...
    <div class="flex items-center content-around space-x-4 ml-auto pt-[15px]">
        ...
        <div class="flex justify-end">
            ...
            <div id="searchContainer"
                class="flex items-center overflow-hidden transition-all duration-300 bg-transparent">

                <!-- Search Icon -->
                <button id="searchIcon"
                    class="cursor-pointer p-2 text-white hover:text-gray-300 transition-colors duration-200 flex-shrink-0">
                ...
                <input type="text" id="searchInput" placeholder="Titles, people, genres"
                    class="flex-0 w-0 opacity-0 bg-black text-white text-sm  py-2 placeholder-gray-400 transition-all duration-300 focus:outline-none" />
            </div>
        </div>
        ...
        <div id="notificationWrapper" class="relative inline-block notification-container">
            <button class="text-white pt-2 hover:text-gray-300 transition-colors duration-200 relative">
                <svg viewBox="0 0 24 24" width="24" height="24" data-icon="BellMedium" data-icon-id=":r1:"
           ...
           opacity-0 translate-y-[-10px] pointer-events-none transition-all duration-300">
                <!-- Netflix Lookahead -->
            ...
            transition-colors duration-200 hover:bg-white/5">
                    <div
                        class="flex-shrink-0 w-28 h-16 bg-black rounded border border-gray-700 flex items-center justify-center relative">
                ...
                <!-- The Game -->
                <div class="notification-item flex items-start gap-3 p-2 border-b border-gray-800 cursor-pointer">
                    <div class="flex-shrink-0 w-28 h-16 bg-blue-900 rounded overflow-hidden">
                ...
                <div class="notification-item flex items-start gap-3 p-2 border-b border-gray-800 cursor-pointer">
                    <div
                        class="flex-shrink-0 w-28 h-16 bg-gradient-to-br from-orange-500 to-pink-500 rounded overflow-hidden flex items-center justify-center">
                ...
                <div class="notification-item flex items-start gap-3 p-2 cursor-pointer">
                    <div
                        class="flex-shrink-0 w-28 h-16 bg-red-700 rounded overflow-hidden flex items-center justify-center">
        ...
        <div id="profileWrapper" class="relative inline-block">
            ...
            <button id="profileBtn" class="flex items-center space-x-2 focus:outline-none group">
                ...
                <svg id="dropdownIcon"
                    class="w-4 h-4 text-white transition-transform group-hover:rotate-180 duration-200" fill="none"
            ...
            {{-- Dropdown Menu --}}
            <div id="dropdownMenu"
                class="absolute right-0 mt-2 w-[200px] bg-black/70  shadow-2xl hidden border border-gray-800">
                ...
                <div class="py-2 border-b border-gray-800">
                    ...
                    <a href="#" class="flex items-center px-2 py-1 hover:bg-white/10 transition !no-underline">
                        <img src="{{ asset('storage/netflix-avatar/Netflix-avatar.png') }}" alt="Darshit"
                    ...
                    {{-- Profile 2 --}}
                    <a href="#" class="flex items-center px-2 py-1 hover:bg-white/10 transition !no-underline">
                        <img src="{{ asset('storage/netflix-avatar/Netflix-avatar.png') }}" alt="Vivek"
                            class="w-8 h-8 rounded mr-3">
                    ...
                    {{-- Profile 3 --}}
                    <a href="#" class="flex items-center px-2 py-1 hover:bg-white/10 transition !no-underline">
                        <img src="{{ asset('storage/netflix-avatar/Netflix-avatar.png') }}" alt="Germany"
                            class="w-8 h-8 rounded mr-3">
                    ...
                    {{-- Profile 4 - Children --}}
                    <a href="#" class="flex items-center px-2 py-1 hover:bg-white/10 transition !no-underline">
                        <img src="{{ asset('storage/netflix-avatar/Netflix-avatar.png') }}" alt="Children"
                            class="w-8 h-8 rounded mr-3">
                ...
                <div class="py-2 border-b border-gray-800">
                    ...
                    <a href="{{ route('accountSettings') }}"
                        class="flex items-center px-2 py-1 hover:bg-white/10 transition !no-underline">
                        <svg class="w-5 h-5 text-gray-400 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="py-2">
                    <form action="{{ route('logout') }}" method="POST">
                        @csrf
                        <button type="submit"
                            class="w-full text-center px-2 py-1 hover:bg-white/10 transition text-white text-sm">
                            Sign out of Netflix
                        </button>
                    </form>
                </div>
