<footer class="bg-[#141414] text-[#99a1af] py-2 px-4 md:px-16 ">
    <div class="max-w-6xl mx-auto">

        <div class="flex space-x-6 mb-8">
            <a href="https://www.facebook.com/netflix" target="_blank" aria-label="Facebook" class="text-xl hover:text-white transition duration-300 no-underline! text-white">
                <svg viewBox="0 0 24 24" width="24" height="24" data-icon="FacebookMedium" data-icon-id=":r7v:" aria-hidden="true" class="svg-icon svg-icon-facebook-logo" xmlns="http://www.w3.org/2000/svg" fill="none" role="img">
            ...
            <a href="https://www.instagram.com/netflix" target="_blank" aria-label="Instagram" class="text-xl hover:text-white transition duration-300 no-underline! text-white">
                <svg viewBox="0 0 24 24" width="24" height="24" data-icon="InstagramMedium" data-icon-id=":r80:" aria-hidden="true" class="svg-icon svg-icon-instagram-logo" xmlns="http://www.w3.org/2000/svg" fill="none" role="img">
            ...
            <a href="https://twitter.com/netflix" target="_blank" aria-label="Twitter" class="text-xl hover:text-white transition duration-300 no-underline! text-white">
                <svg viewBox="0 0 24 24" width="24" height="24" data-icon="TwitterMedium" data-icon-id=":r81:" aria-hidden="true" class="svg-icon svg-icon-twitter-logo" xmlns="http://www.w3.org/2000/svg" fill="none" role="img">
            ...
            <a href="https://www.youtube.com/user/netflix" target="_blank" aria-label="YouTube" class="text-xl hover:text-white transition duration-300 no-underline! text-white">
                <svg viewBox="0 0 24 24" width="24" height="24" data-icon="YoutubeMedium" data-icon-id=":r82:" aria-hidden="true" class="svg-icon svg-icon-youtube-logo" xmlns="http://www.w3.org/2000/svg" fill="none" role="img">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 text-sm">
            <ul class="space-y-3">
                <li><a href="#" class="hover:underline no-underline! text-white">Audio Description</a></li>
                <li><a href="#" class="hover:underline no-underline! text-white">Investor Relations</a></li>
                <li><a href="#" class="hover:underline no-underline! text-white">Legal Notices</a></li>
            </ul>
            <ul class="space-y-3">
                <li><a href="#" class="hover:underline no-underline! text-white">Help Centre</a></li>
                <li><a href="#" class="hover:underline no-underline! text-white">Jobs</a></li>
                <li><a href="#" class="hover:underline no-underline! text-white">Cookie Preferences</a></li>
            </ul>
            <ul class="space-y-3">
                <li><a href="#" class="hover:underline no-underline! text-white">Gift Cards</a></li>
                <li><a href="#" class="hover:underline no-underline! text-white">Terms of Use</a></li>
                <li><a href="#" class="hover:underline no-underline! text-white">Corporate Information</a></li>
            </ul>
            <ul class="space-y-3">
                <li><a href="#" class="hover:underline no-underline! text-white">Media Centre</a></li>
                <li><a href="#" class="hover:underline no-underline! text-white">Privacy</a></li>
                <li><a href="#" class="hover:underline no-underline! text-white">Contact Us</a></li>
            </ul>
        </div>
        <div class="text-xs pt-4 text-gray-500">
