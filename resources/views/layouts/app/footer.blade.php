<footer class="bg-[#141414] text-[#99a1af] py-2 px-4 md:px-16 ">
    <div class="max-w-6xl mx-auto">
        ...
        <div class="flex space-x-6 mb-8">
            <a href="https://www.facebook.com/netflix" target="_blank" aria-label="Facebook"
                class="text-xl hover:text-white transition duration-300 !no-underline text-white">
                <svg viewBox="0 0 24 24" width="24" height="24" data-icon="FacebookMedium" data-icon-id=":r7v:"
                    aria-hidden="true" class="svg-icon svg-icon-facebook-logo" xmlns="http://www.w3.org/2000/svg"
                    fill="none" role="img">
            ...
            <a href="https://www.instagram.com/netflix" target="_blank" aria-label="Instagram"
                class="text-xl hover:text-white transition duration-300  !no-underline text-white">
                <svg viewBox="0 0 24 24" width="24" height="24" data-icon="InstagramMedium" data-icon-id=":r80:"
                    aria-hidden="true" class="svg-icon svg-icon-instagram-logo" xmlns="http://www.w3.org/2000/svg"
                    fill="none" role="img">
                    <path fill-rule="evenodd" clip-rule="evenodd"
            ...
            <a href="https://twitter.com/netflix" target="_blank" aria-label="Twitter"
                class="text-xl hover:text-white transition duration-300 !no-underline text-white">
                <svg viewBox="0 0 24 24" width="24" height="24" data-icon="TwitterMedium" data-icon-id=":r81:"
                    aria-hidden="true" class="svg-icon svg-icon-twitter-logo" xmlns="http://www.w3.org/2000/svg"
                    fill="none" role="img">
                    <path fill-rule="evenodd" clip-rule="evenodd"
            ...
            <a href="https://www.youtube.com/user/netflix" target="_blank" aria-label="YouTube"
                class="text-xl hover:text-white transition duration-300 !no-underline text-white">
                <svg viewBox="0 0 24 24" width="24" height="24" data-icon="YoutubeMedium" data-icon-id=":r82:"
                    aria-hidden="true" class="svg-icon svg-icon-youtube-logo" xmlns="http://www.w3.org/2000/svg"
                    fill="none" role="img">
                    <path fill-rule="evenodd" clip-rule="evenodd"
