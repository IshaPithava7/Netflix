...
<body class="p-0 m-0 box-border font-sans bg-black text-white overflow-x-hidden">
    <div class="hero-section relative h-screen flex flex-col">
        <div class="hero-background absolute inset-0 w-full h-full bg-cover bg-center z-0" style="background-image: linear-gradient(to bottom, rgba(0, 0, 0, 0.7) 0%, rgba(0, 0, 0, 0.4) 50%, rgba(0, 0, 0, 0.95) 100%), url('https://assets.nflxext.com/ffe/siteui/vlv3/151f3e1e-b2c9-4626-afcd-6b39d0b2694f/web/IN-en-20241028-TRIFECTA-perspective_bce9a321-39cb-4cce-8ba6-02dab4c72e53_large.jpg');">
        ...
        <div class="hero-content flex flex-1 flex-col justify-center items-center text-center p-8 max-w-[800px] mx-auto z-10">
            ...
            <form id="email-form" class="email-form flex flex-col md:flex-row gap-4 w-full max-w-3xl md:max-w-[600px]" method="POST" action="{{ route('checkEmail') }}">
                @csrf

                <div class="flex flex-col flex-1 w-full relative">
                    <input type="text " name="email" id="email-input" class="email-input bg-black/70 border border-gray-500/70 rounded-md text-white py-3 px-2 text-base
        ...
        flex items-center justify-center whitespace-nowrap transition hover:bg-[#f40612] focus:outline-none ">
                    Get Started
                    <span class="ml-1 text-3xl leading-none"><svg viewBox="0 0 24 24" width="24" height="24" data-icon="ChevronRightMedium" data-icon-id=":r3:" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" role="img">
                            <path fill="currentColor" fill-rule="evenodd" d="m15.59 12-7.3 7.3 1.42 1.4 8-8a1 1 0 0 0 0-1.4l-8-8-1.42 1.4z" clip-rule="evenodd">
                            </path>
                        </svg></span>
                </button>
            </form>
