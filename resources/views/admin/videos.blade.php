        ...
        <table class="min-w-full bg-black text-white rounded overflow-hidden">
            ...
            <tbody>
                ...
                <tr class="border-b border-gray-700 items-center">
                    ...
                    <td class="py-2 px-4">
                        @if($video->poster)
                        <img src="{{ asset('storage/' . $video->poster) }}" alt="Poster" class="w-40 h-12 object-cover rounded" loading="lazy">
                        @else
                    ...
                    <td class="py-2 px-4 align-middle text-center">
                        ...
                        <div class="inline-block w-48 relative group">
                            {{-- Thumbnail --}}
                            <img src="{{ asset('storage/' . ($video->poster ?? 'defaults/poster.jpg')) }}" alt="{{ $video->title }}" class="w-full rounded cursor-pointer lazy-thumb" data-src="{{ asset('storage/' . $video->file_path) }}" onclick="playVideo(this)" loading="lazy">
                    ...
                    <td class="py-2 px-4">
                        ...
                        <img src="{{ asset('storage/' . $video->title_poster) }}" alt="Title Poster" class="w-40 h-12 object-cover rounded" loading="lazy">
                        @else
                        <span class="text-gray-400">No Image</span>
                        @endif
                    </td>
