<div id="sectionInfoModal" class="fixed inset-0 bg-black/30 backdrop-blur-[1px] flex items-start py-6 justify-center opacity-0 pointer-events-none transition-opacity duration-300 z-50 overflow-y-auto">

    <div class="bg-[#181818] w-[850px] max-w-4xl rounded-lg overflow-hidden relative shadow-2xl">

        <!-- Close Button -->
        <button id="closeModal" class="absolute top-4 right-4 flex items-center justify-center w-8 h-8 rounded-full bg-[#181818] text-white text-3xl font-light z-50">
            <svg viewBox="0 0 24 24" width="18" height="18" data-icon="XMedium" data-icon-id=":r2c:" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" role="img">
        ...
        <div class="relative w-full max-w-[850px] h-[480px] bg-black overflow-hidden">
            <video id="sectionModalVideo" class="absolute inset-0 w-full h-full object-cover hidden" autoplay muted loop playsinline>
                <source src="" type="video/mp4">
            </video>

            <img id="sectionModalPoster" class="absolute inset-0 w-full h-full object-cover hidden" alt="Poster" loading="lazy" />
            ...
            <div class="absolute bottom-20 left-15 z-10 transition-opacity duration-700 opacity-100">
                <img id="sectionModalTitlePoster" loading="lazy" alt="more-inf" class="mb-6 w-[300px] h-auto object-contain transition-all duration-700">

                <div class="flex items-center space-x-4 mt-4">
                    <button class="flex items-center justify-center space-x-2 bg-white text-black font-bold w-[126px] h-[46px] rounded-md! hover:bg-gray-300 transition duration-300">
                    ...
                    <!-- Add to List -->
                    <button class="flex items-center justify-center w-[46px] h-[46px] rounded-full! bg-[#2a2a2a99] hover:bg-[Transparent] hover:border-[#ffffff] text-white transition duration-300 border-2 border-[#ffffff80]">
                    ...
                    <!-- Thumbs Up -->
                    <button class="flex items-center justify-center w-[46px] h-[46px] rounded-full! bg-[#2a2a2a99] hover:bg-[Transparent] hover:border-[#ffffff] text-white transition duration-300 border-2 border-[#ffffff80]">
                        <svg viewBox="0 0 24 24" width="24" height="24" data-icon="ThumbsUpMedium" data-icon-id=":ra8:" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" role="img">
        ...
        <div class="px-10 pb-10 bg-[#181818]">
            ...
            <div class="grid grid-cols-3  gap-4">
                ...
                <div class="bg-[#2f2f2f] rounded overflow-hidden group relative hover:scale-[1.03] transition-transform duration-300">
                    <div class="relative">
                        @if($poster)
                        <img src="{{ $poster }}" alt="{{ $video->title }}" class="w-full h-40 object-cover" loading="lazy">
                        @else
                    ...
                    <div class="p-3">
                        <div class="flex items-center justify-between mb-2">
                            ...
                            {{-- Add / Remove My List --}}
                            <button class="toggle-mylist flex items-center justify-center w-8 h-8 rounded-full border-2 border-gray-400 bg-black/50 hover:bg-white/20 text-white transition" data-video-id="{{ $video->id }}">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" id="mylist-icon-{{ $video->id }}">
        ...
        <div class="flex justify-center py-2 bg-[#181818]">
            <button class="flex items-center justify-center w-10 h-10 rounded-full border-2 border-gray-600 bg-transparent hover:border-white text-white transition">
                <svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor">
        ...
        <div class="px-10 pb-6 bg-[#181818]">
            ...
            <div class="mb-8">
                <div class="relative rounded overflow-hidden cursor-pointer hover:scale-105 transition-transform duration-300 inline-block">
                    <img src="https://images.unsplash.com/photo-1536440136628-849c177e76a1?w=220&h=124&fit=crop" loading="lazy" alt="Trailer" class="w-56 h-32 object-cover">
