    ...
    <div class="bg-[#181818] w-[850px] max-w-4xl rounded-lg overflow-hidden relative shadow-2xl">
        ...
        <div class="relative w-[850px] h-[500px] overflow-hidden shadow-2xl">
            ...
            @if($featured->file_path)
                <video id="modalVideo"
                    class="w-full h-full object-cover absolute inset-0 opacity-0 transition-opacity duration-700" muted
            ...
            <div class="grid grid-cols-3 gap-8">
                ...
                <div class="col-span-2 ">
                    ...
                    <div class="flex items-center gap-3 mb-4">
                        <span class="text-[#bcbcbc] font-semibold text-sm">2022</span>
                        <span class="text-[#bcbcbc] text-sm">2h 7m</span>
                    ...
                    <div class="flex items-center gap-2 mb-5">
                        <span class="border rounded border-[#ffffff66] text-white text-xs px-2 py-1 font-semibold">U/A
                            16+</span>
                        <span class="text-gray-400 text-sm">gore, sexual content, violence</span>
                    </div>
                ...
                <div class="space-y-3 text-sm">
                    ...
                    <div>
                        ...
                        <span class="text-white">John Abraham, Arjun Kapoor, Disha Patani, </span>
                        <span class="text-[#777] italic">more</span>
                    </div>

                    <!-- Genres -->
                    <div>
                        <span class="text-[#777]">Genres: </span>
                        <span class="text-white">Hindi-Language Movies, Bollywood Movies, Crime
                            Movies</span>
                    </div>
...
<script>
    ...
    $('.toggle-mylist').click(function () {
        const videoId = $(this).data('video-id');
        const icon = $('#mylist-icon-' + videoId);
        $.post("{{ route('mylist.toggle') }}", {
            _token: "{{ csrf_token() }}",
            video_id: videoId
        }, function (data) {
            if (data.status === 'added') {
                icon.html('<path d="M5 13l4 4L19 7" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" />');
            } else {
                icon.html('<path d="M11 11V2H13V11H22V13H13V22H11V13H2V11H11Z"></path>');
            }
        });
    });
</script>