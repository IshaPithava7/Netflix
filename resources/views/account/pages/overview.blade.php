    ...
    <div class="flex-1">
        ...
        <div class="border-b border-gray-300 pb-8 mb-8">
            ...
            <div class="bg-white border border-gray-200 rounded-lg p-6">
                ...
                <div class="flex items-center gap-2 mb-4">
                    <span
                        class="bg-linear-to-r from-purple-600 to-red-600 text-white text-sm font-semibold px-4 py-1 rounded-full">
                ...
                @if($subscription && $subscription->active())
                    ...
                    <div class="mt-6 pt-6 border-t border-gray-200">
                        <button onclick="window.location.href='#'"
                            class="flex items-center justify-between w-full text-left hover:underline group">
        ...
        <div class="mb-8">
            ...
            <div class="bg-white border border-gray-200 rounded-lg overflow-hidden">
                {{-- Change Plan --}}
                <a href="{{ route('subscription') }}"
                    class="flex items-center justify-between px-6 py-4 hover:bg-gray-50 transition border-b border-gray-200 group no-underline">
                ...
                {{-- Edit Settings --}}
                <a href="#"
                    class="flex items-center justify-between px-6 py-4 hover:bg-gray-50 transition group no-underline">
                    <div class="flex items-center gap-4">
                        <div class="w-10 h-10 flex items-center justify-center">
                            <svg class="w-6 h-6 text-gray-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="#"
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div class="flex -space-x-2">
                            <img src="https://i.pravatar.cc/150?img=1" alt="Profile 1"
                                class="w-8 h-8 rounded-full border-2 border-white">
                            <img src="https://i.pravatar.cc/150?img=2" alt="Profile 2"
                                class="w-8 h-8 rounded-full border-2 border-white">
                            <img src="https://i.pravatar.cc/150?img=3" alt="Profile 3"
                                class="w-8 h-8 rounded-full border-2 border-white">
                            <img src="https://i.pravatar.cc/150?img=4" alt="Profile 4"
                                class="w-8 h-8 rounded-full border-2 border-white">
                            <div
                                class="w-8 h-8 rounded-full border-2 border-white bg-red-500 flex items-center justify-center text-white text-xs font-bold">
                                K
                            </div>
                        </div>
                    </div>
